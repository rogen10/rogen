...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/rogen10/rogen/main/File_Bot/commands.lua") 
...
os.execute('wget https://raw.githubusercontent.com/rogen10/rogen/main/DRAGON.lua')
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/rogen10/rogen/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/rogen10/rogen/main/File_Bot/"..file)
if res == 200 then
...
if text == 'باندا بيعيط' or text == 'باند' or text == 'api' then
local Text = [[ 
باندا ابو شخه اهو 😂😂😂😂❤️
]]
keyboard = {}  
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/SO_ROGEN/265&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'باندا العبيط' or text == 'بندا or text == 'بنضدا' then
local Text = [[ 
باندا العبيط اهو🙂😹
]]
keyboard = {}  
